...
export default function Cart() {
  ...
  useEffect(() => {
    ...
    const savedCart = savedCartData ? JSON.parse(savedCartData) : [];
    ...
    const totalSavings = savedCart.reduce((sum: number, item: CartItem) => {
              ...
              <div className="mt-6 pt-6 border-t border-gray-200">
                ...
                <div className="space-y-3">
                  {cartItems.slice(0, 2).map((item) => (
                    <div
                      key={`rec-${item.id}`}
                      className="flex gap-3 p-3 border border-gray-200 rounded hover:shadow-sm transition-shadow"
                    >
