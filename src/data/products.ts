...
export const categoryTitles = [
  "Up to 50% off | Home decoration to elevate your space",        // home-decoration
  "Up to 55% off | Stylish and durable furniture for every room", // furniture
  "Up to 55% off | Elegant and smart men's watches",          // mens-shirts
  "Up to 35% off | Best-selling laptops for work and play",       // laptops
  "Up to 60% off | Premium and long-lasting fragrances",          // fragrances
  "Up to 60% off | Men's shoes for style and comfort",  
  "Up to 50% off | Trendy men’s shirts for every occasion",          // mens-shoes
  "Up to 45% off | Kitchen accessories for cooking", // kitchen-accessories
];


export const categoryColors = {
  "home-decoration": "bg-orange-200",   // light orange
  "beauty": "bg-pink-50",              // light pink
  "fragrances": "bg-purple-200",        // light purple
  "furniture": "bg-amber-50",          // light brown
  "kitchen-accessories": "bg-lime-50", // lime green
  "laptops": "bg-indigo-50",           // light indigo
  "mens-shirts": "bg-blue-50",         // light blue
  "mens-shoes": "bg-cyan-50",          // light cyan
  "mobile-accessories": "bg-violet-50",// light purple
  "motorcycle": "bg-red-50",           // light red
  "skin-care": "bg-orange-50",         // orange
  "smartphones": "bg-sky-50",          // light sky
  "sports-accessories": "bg-slate-50", // light blue grey
  "sunglasses": "bg-yellow-200",        // light yellow
  "tablets": "bg-indigo-200",           // light indigo
  "tops": "bg-rose-200",                // light rose
  "vehicle": "bg-stone-200",            // light brown/stone
  "womens-bags": "bg-pink-300",         // soft pink
  "womens-dresses": "bg-fuchsia-200",   // light fuchsia
  "womens-jewellery": "bg-purple-200",  // light purple
  "womens-shoes": "bg-violet-200",      // violet
  "womens-watches": "bg-purple-100",    // lavender
};
